...
import CONSOLE from '../../../src/lib/constants/console'
import { CACHE, DATA } from '../../../src/lib/constants/filePaths'
import path from 'node:path'
import COVER_TYPE from '../../../src/lib/constants/coverType'
...
export default class Covers extends ModuleBase {
  ...
  async downloadCover (console: string, type: string, gameId: string, region: string): Promise<string> {
    ...
    const response = await axios(this.getBaseURL(console, type, region, gameId, this.getExtension(type, console)), { responseType: 'arraybuffer', validateStatus: () => true })
